...
Display()
{
	...
	glPushMatrix();
	glTranslatef(0., 0, -3.);
	//glLightfv(GL_LIGHT0, GL_POSITION, Array3(1, 1, 1));
	//	SetSpotLight(GL_LIGHT1, 0., 0., 1., 0., 1., 0., 1., 1., 1.); // white light
	//  glEnable(GL_LIGHT0);
	
	//glutSolidSphere(0.55, 30, 30);                    //start after some time
	glPopMatrix();
	...
	/*
	if (Light1On == 1) {                                                                  //stable white light
		SetPointLight(GL_LIGHT3, 3., 0, -3, 1., 0., 1.);
	}
	...
	glPushMatrix();
	if (Light2On == 1){
			SetPointLight(GL_LIGHT3, 3., 0, -3, 1., 1., 1.);
...
/*	glPushMatrix();
	...
	if (Light2On == 1) {
		SetPointLight(GL_LIGHT3, 0., 3, -3, 1., 0., 0.);
	}
	else if (Light2On == 0) {
		glDisable(GL_LIGHT3);
	}
	...
	//	glEnable(GL_LIGHT3);
	GLdouble s_x;
	//	for (s_x = 0; s_x < 100; s_x++) {


	//	glTranslated(Time, 0, 0);
	...
	glPushMatrix();
	//glTranslatef(0., 0, -1.);
	//SetPointLight(GL_LIGHT4, 0., 0., 1., 1., 0., 0.);
	//glLightfv(GL_LIGHT0, GL_POSITION, Array3(1, 1, 1));
	//glEnable(GL_LIGHT4);
	//glColor3f(1.0, 0., 0.);
	//glutSolidSphere(0.55, 30, 30);
