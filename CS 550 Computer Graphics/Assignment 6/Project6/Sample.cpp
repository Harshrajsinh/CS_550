...
Display( )
{
	...
	for (int j = 0; j < curves; j++) {
		...
		curve.p1 = p1;
		struct Point p2 = { ((sin(2 * PI*Time) / 6) + 1.25) * cos(angle / 3) * 1, ((sin(2 * PI*Time) / 6) + 1.25) * 1,1 * sin(3 * angle)*((sin(2 * PI*Time) / 6) + 1.25) };
		curve.p2 = p2;
		struct Point p3 = { cos(angle / 1) * 2, 2. - ((sin(2 * PI*Time) / 6) + 1.25) * 2,2 * sin(angle / 1) };
		curve.p3 = p3;
